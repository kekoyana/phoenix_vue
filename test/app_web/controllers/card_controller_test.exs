defmodule AppWeb.CardControllerTest do
  ...
  @create_attrs %{action_1_id: 42, action_2_id: 42, action_3_id: 42, action_4_id: 42, attack: 42, attribution_1_id: 42, attribution_2_id: 42, defence: 42, magic: 42, max_hp: 42, name: "some name", resist: 42, speed: 42}
  ...
  def fixture(:card) do
    {:ok, card} = Deck.create_card(@create_attrs)
    card
  end
